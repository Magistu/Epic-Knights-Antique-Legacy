...
public class GildedGalleaModel {
	...
	public static LayerDefinition createLayer() {
		...
		.texOffs(0, 33).addBox(-5.5F, -5.0F, -1.0F, 11.0F, 2.0F, 2.0F, new CubeDeformation(0.15F))
		.texOffs(0, 11).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.8F))
		.texOffs(-11, 53).addBox(-7.5F, -2.825F, 0.2F, 15.0F, 0.0F, 11.0F, new CubeDeformation(0.05F))
		.texOffs(24, 11).addBox(-5.5F, -7.35F, -6.525F, 11.0F, 1.0F, 4.0F, new CubeDeformation(0.025F))
		.texOffs(56, 25).addBox(-1.0F, -9.775F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
