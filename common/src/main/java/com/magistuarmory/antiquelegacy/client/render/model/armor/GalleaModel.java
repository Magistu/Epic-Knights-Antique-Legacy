...
public class GalleaModel {
	...
	public static LayerDefinition createLayer() {
		...
		.texOffs(-9, 42).addBox(-7.5F, -2.825F, 0.2F, 15.0F, 0.0F, 11.0F, new CubeDeformation(0.05F))
		.texOffs(24, 11).addBox(-5.5F, -7.35F, -6.525F, 11.0F, 1.0F, 4.0F, new CubeDeformation(0.025F)), PartPose.offset(0.0F, 0.0F, 0.0F));
