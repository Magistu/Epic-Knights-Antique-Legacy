...
public class AgenPortHelmetModel
{
	...
	public static LayerDefinition createLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 15).addBox(-4.0F, -9.0F, -4.0F, 8.0F, 9.0F, 8.0F, new CubeDeformation(0.6F))
				.texOffs(0, 0).addBox(-7.0F, -4.2F, -7.0F, 14.0F, 1.0F, 14.0F, new CubeDeformation(0.95F))
				.texOffs(0, 32).addBox(-7.0F, -1.875F, -7.0F, 14.0F, 1.0F, 14.0F, new CubeDeformation(0.95F))
				.texOffs(32, 15).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.8F)), PartPose.offset(0.0F, 0.0F, 0.0F));
